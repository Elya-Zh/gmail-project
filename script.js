...
// mainContainer.addEventListener('click',(a)=>{
//     mainContainer.innerHTML = '';
//   let everyEmail = document.createElement('div');
//   everyEmail.setAttribute('class','eachDiv');
//   mainContainer.appendChild(everyEmail)
//   everyEmail.forEach(function(elem, index, arr){
//       return 
//       everyEmail.innerHTML = `<h1>${a.messageTitle}</h1>`
//     })
//     console.log(elem)
//   console.log(a.messageTitle)
...
//     mainContainer.appendChild(help);
//     help.style.width = '100px';
//     help.style.marginTop = '15px'
